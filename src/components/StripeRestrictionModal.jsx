      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden border-0 shadow-2xl">
        <div className="bg-white">
          ...
          <div className="relative mt-4">
            ...
            <div className="bg-gradient-to-b from-blue-50 to-white pt-10 pb-6 px-8 rounded-t-3xl border-t border-blue-100 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] relative z-0 mt-[-20px]">
              ...
              <div className="mt-8">
                <Button 
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white text-lg py-6 shadow-lg shadow-blue-200 transition-all hover:scale-[1.02]"
                >
